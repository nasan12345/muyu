...
const PHASES = {
  1: { name:'困', color:'#b0a0b8', colorDeep:'#a090a8', bell:'无', eyes:'疲惫半眯',
       image:'images/phase1_kun.jpg', storyImg:'images/s1.jpg', pracImg:'images/p1.jpg', greeting:'……敲一下试试？', cat:'瘦小猫，缩在木鱼后面不敢敲' },
  2: { name:'求', color:'#b8a0c8', colorDeep:'#a890b8', bell:'木槌', eyes:'睁眼好奇',
       image:'images/phase2_qiu.jpg', storyImg:'images/s2.jpg', pracImg:'images/p2.jpg', greeting:'在找鼓点？', cat:'稍胖，爪子搭在木鱼上' },
  3: { name:'撞', color:'#a080b8', colorDeep:'#9070a8', bell:'木鱼+裂痕', eyes:'低头沉思',
       image:'images/phase3_zhuang.jpg', storyImg:'images/s3.jpg', pracImg:'images/p3.jpg', greeting:'敲破了？没事。', cat:'圆润，木鱼上有裂痕但还在敲' },
  4: { name:'醒', color:'#8a60a8', colorDeep:'#7a5098', bell:'金槌', eyes:'半闭有神',
       image:'images/phase4_xing.jpg', storyImg:'images/s4.jpg', pracImg:'images/p4.jpg', greeting:'你的节奏，找到了吗？', cat:'胖乎乎，闭眼也能敲准' },
  5: { name:'行', color:'#6a4088', colorDeep:'#5a3078', bell:'无槌，以心为槌', eyes:'闭目微笑',
       image:'images/phase5_xing.jpg', storyImg:'images/s5.jpg', pracImg:'images/p5.jpg', greeting:'笃。笃。笃。', cat:'自在，木鱼声和心跳同频' },
};
